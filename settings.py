...
# Configs Gerais
IDBOT = 46
DIAS_VISTORIA_CORTE = 15
DIAS_LIMITE_VISTORIA = 5
...
COLUNAS_FLUIG_UTILIZADAS = ['STATUS', 'NUM_PROCES', 'CHAVEACESSONFCOMPRA', 'DESCRICAOFORNECEDOR']
COLUNAS_UTILIZADAS_NO_PROCESSO = ['cnpjRemetenteFmt', 'numeroNf', 'STATUS', 'NUM_PROCES', 'qtdDias', 'CHAVEACESSONFCOMPRA', 'DESCRICAOFORNECEDOR']